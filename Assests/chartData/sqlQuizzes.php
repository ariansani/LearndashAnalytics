...
$query ="SELECT wp_users.display_name as 'User',{$wpdb->prefix}learndash_user_activity.course_id as 'Course ID',{$wpdb->prefix}learndash_user_activity.activity_status as 'Activity Status', {$wpdb->prefix}posts.post_title as 'Quiz Name'
...
WHERE {$wpdb->prefix}learndash_user_activity.activity_type ='quiz' AND {$wpdb->prefix}posts.post_status ='publish'";
